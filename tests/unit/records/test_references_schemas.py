...
@patch('inspirehep.modules.records.serializers.schemas.json.get_resolved_references')
def test_references_schema_wit_record(mock_get_resolved_references):
    schema = ReferencesSchemaJSONUIV1()
    mock_get_resolved_references.return_value = [{
        'control_number': 123,
        'titles': [
            {
                'title': 'Jessica Jones',
